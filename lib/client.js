...
`;
    ...
    const DEFAULT_SETTINGS = { visible: true, saveMode: false, costLimit: 0, tokenLimit: 0, hourlyTokenLimit: 0, autoMode: 'off', peakMaxTokensOn: false, peakMaxTokens: 0 };
    ...
    function BalanceSettingsRow() {
      ...
      return React.createElement(
        ...
        React.createElement('div', { key: 'r6', style: { display: 'flex', alignItems: 'center', gap: 10, fontSize: 12 } },
          React.createElement('span', { key: 'mtl', style: { color: 'var(--dsw-alias-label-secondary,#888)' } },
            '高峰限 max_tokens'),
          React.createElement('input', {
            key: 'mton',
            type: 'checkbox',
            checked: settings.peakMaxTokensOn === true,
            onChange: (e) => update({ peakMaxTokensOn: e.target.checked }),
          }),
          React.createElement('input', {
            key: 'mtv',
            type: 'number',
