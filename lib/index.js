        ...
        try {
          ...
          json(res, {
            ...
            enforcement: {
              ...
              active: gateEnabled && overBudget(payload),
              compressEnabled,
              compressActive: compressEnabled && usedPercent(payload) >= compressAtPercent,
              compressAtPercent,
              compressCount,
            },
          })
      ...
      handler: async (req, res) => {
        try {
          ...
          json(res, {
            ...
            overBudget: over,
            active: gateEnabled && over,
            compressEnabled,
            compressActive: compressEnabled && usedPercent(u) >= compressAtPercent,
            compressAtPercent,
            compressCount,
          })
        } catch (e) { json(res, { ok: false, error: String((e && e.message) || e).slice(0, 200) }, 500) }
